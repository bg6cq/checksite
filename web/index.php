...
?>
   ...
   <p class="lead"><form method=get action=onlinecheck.php>请输入主机名：<input name=hostname value="www.ustc.edu.cn"><input type=submit name=cmd value="开始测试">  <a href=onlinechecklog.php>最后100条在线测试结果</a></form></p>
  </div>
</div>
